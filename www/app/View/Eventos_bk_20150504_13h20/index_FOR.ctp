                        ...
                        <div class="row">
                             <?php
                                ...
                                for($i=0; $i<count($evento); $i++){
                                    $countImg = count($evento[$i]['imagem_destacada_'.$lang.'_file']);
                                    if($countImg == 1){
                                        $fechaAbreRow = "</div><div class='row'>";
                                    }
                                    if( $evento[$i]['imagem_destacada_'.$lang.'_file'] != '' ){
                                        ?>
                                        <div class='medium-6 small-12 columns event img'>
                                            <div class='date'>
                                                <p><?= $this->Time->format('d.m.Y', $evento[$i]['data']);?></p>
                                                <div></div> 
                                            </div>
                                                ...
                                                <div class="area-imagem">
                                                    <a href="<?=$this->Html->url(
                                                                    array(
                                                                        'controller' => 'eventos', 
                                                                        'action' => 'mostrar_evento', 
                                                                        $evento[$i]['url_amigavel_'.$lang]
                                                                    )) ?>">
                                                        <div class="imagem" style="background-image: url(<?=$this->webroot.$evento[$i]['imagem_destacada_'.$lang.'_file']?>)"></div>
                                                    </a>
                                                </div>
                                                <div class='title'>
                                                    <a href='<?=$this->Html->url(
                                                ...
                                                <div class='text'>
                                                    <a href='<?=$this->Html->url(
                                                                                array(
                                                                                    'controller' => 'eventos', 
                                                                                    'action' => 'mostrar_evento', 
                                                                                    $evento[0]['url_amigavel_'.$lang]
                                                                                )) ?>'>
                                                        <p><?= $evento[0]['descricao_'.$lang];?></p>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        $fechaAbreRowSemImagem = '';
                                        if($i%2==1){
                                            $fechaAbreRowSemImagem = "</div><div class='row'>";
                                        }
                                        ?>
