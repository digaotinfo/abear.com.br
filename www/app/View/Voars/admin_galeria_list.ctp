...
<div id="content" style="padding-left:80px">
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tbody>
			...
			<?php
			//>>> caso tenha paramentros na busca
			if(!empty($resultBusca)){
				$registros = $resultBusca;
			}
			//<<< caso tenha paramentros na busca
				...
				<tr>
					...
					<td class="actions">
						<a href=' <?=$this->Html->url(array(	 	
												'action' => 'admin_galeria_edit', $r[$model]['id']
												)
										);
						...
						<?=$this->Form->postLink('Excluir',
								array('action' => 'admin_galeria_delete', $r[$model]['id']),
...
<div style="float:left;height:500px;">
    <div class="actions">
        <h3>Açoes</h3>
        <ul>
            <li><a href="<?php echo $this->Html->url(array('action' => 'admin_galeria_add' ) )?>/?galeria_categoria_id=2">Adicionar Como Voa o Brasil Galeria</a></li>
