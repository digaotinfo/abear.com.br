				...
				<div class='info'>
					...
					<div class='prev_next'>
						...
						if (!empty($neighbors['next'])){?>
							<div class='prev_'>
								<a href="<?=$this->webroot.'videos/'.$categoria.'/'.$neighbors['next'][$model]['url_amigavel_'.$lang]?>/page:<?=$this->Paginator->current()?>"> 
						...
						if (!empty($neighbors['prev'])){?>
							<div class='next_'><a href="<?=$this->webroot.'videos/'.$categoria.'/'.$neighbors['prev'][$model]['url_amigavel_'.$lang]?>/page:<?=$this->Paginator->current()?>"><?=__d('default', 'próximo')?><div></div></a></div>
						<?php
						}else{
