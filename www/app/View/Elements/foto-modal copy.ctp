...
?>
	...
	<div class='top'><div class='first'></div><div class='last'><a href="#" class='modal-pj-close'><?=__d('default', 'fechar')?></a> </div></div>
		...
		<div class='foto'> <?=$this->Html->image('/'.$foto[$model]['img_file'])?></div>
		<div class='info'>
			<div class='title'><p><?=strip_tags($foto[$model]['titulo_'.$lang])?></p></div>
			<div class='text'><p><?=strip_tags($foto[$model]['descricao_'.$lang])?></p></div>
		</div>
		
		<?php $img_modal = $this->webroot.$foto[$model]['img_file'];?>
	...
	<div class='bot'>
        ...
        if(!empty($neighbors['next'][$model]['id'])){
            ...
            ?>
            <div class='prev_'><a href="<?=$this->webroot?>imagem/<?=$parametro_capa_id.'/'.$neighbors['prev'][$model]['id']?>"><?=__d('default', 'Anteriores')?><div></div></a></div>
            <?php
        }else{
        ...
        if(!empty($neighbors['next'][$model]['id'])){
        	...
        	?>
            <div class='next_'><a href="<?=$this->webroot?>imagem/<?=$parametro_capa_id.'/'.$neighbors['next'][$model]['id']?>"><?=__d('default', 'Próximos')?><div></div></a></div>
            <?php
        }else{
